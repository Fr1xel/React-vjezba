...
const Movies = (props) => {
    ...
    return searchMovies.map(movie => {
        if(movie.poster_path){
            return(
            <div className="col-lg-2 col-md-4 col-6 cursor-pointer hover-bigger mx-4" key={movie.id}>
            ...
            return(
            <div className="col-lg-3 col-md-6 col-12 cursor-pointer hover-bigger mx-4" key={movie.id}>
