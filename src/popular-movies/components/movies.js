...
const Movies = (props) => {
  ...
  return movies.map(movie => {
    return (
      <div className="col-lg-3 col-md-6 col-12 cursor-pointer hover-bigger max-width-100 click-info-popular" key = {movie.id} onClick={() => {setModalMovie(movie); setModuleIsOpen(true)}}>
